...
العاب زامن
        ...
        <p className="text-white/80 leading-8">
         منصة ألعاب تفاعلية عربية تجمع العائلة والأصدقاء في تجربة مليئة بالمرح والتحدي. حوّل أي جلسة إلى لحظات لا تُنسى مع ألعاب جماعية متنوعة تعمل مباشرة من المتصفح.
